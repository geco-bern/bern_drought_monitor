...
This drought monitor combines several complementary variables to assess the current drought situation with a focus on the region of Bern, Switzerland: 
  - Potential cumulative water deficit (derived from local MeteoSchweiz station and from ERA5-Land climate reanalysis).
...
# ggsave(here::here("fig", "pcwd_pt.pdf"), width = 8, height = 5)
```
